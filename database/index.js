...
let save = (reposArray) => {
//  console.log('array of repos in mongoose: ' + JSON.parse(reposArray));
  Repo.insertMany(JSON.parse(reposArray), (err) => {
    if (err) {
      console.log('failed!');
    }
    console.log('success!');
...
//   if (err) {
//     return console.log('err find', err);
//   }
//   console.log(repos);
// })
